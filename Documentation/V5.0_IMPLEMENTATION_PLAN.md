...
2. **Monetization** - Stripe integration (subscriptions + one-time payments)
3. **Database-driven pricing** - kara-pricing.md stored in database
4. **User-specific data** - History/favorites tied to auth user instead of device
...
### 3.3 Migration Strategy: Device → Account
